...
public class SignUpFacade {
    ...
    public static void signUpUser(String username, String email, String password) {
        try {
            Connection connection = establishConnection(); // Encapsulating DB connection
            signup(connection, username, email, password); // Encapsulating signup process
            closeConnection(connection); // Encapsulating connection closing
