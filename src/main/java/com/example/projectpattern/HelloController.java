...
public class HelloController {
    ...
    private void navigateToSignUp() {
        try {
            ...
            signUpStage.setTitle("Sign Up"); // Set title for the stage (you can modify as needed)
    ...
    private void loginAction() throws SQLException, IOException {
        ...
        if (userModel.login(enteredUsername, enteredPassword)) {
            ...
            try {
                ...
                afterLoginStage.setTitle("After Login"); // Set title for the stage (modify as needed)
